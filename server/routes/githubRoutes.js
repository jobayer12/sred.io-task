...
router.get('/pull-requests', jwtVerification, fetchPullRequests);
router.get('/commits', jwtVerification, fetchCommits);
router.get('/issues', jwtVerification, fetchIssues);
